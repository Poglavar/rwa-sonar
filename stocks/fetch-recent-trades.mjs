...
NOTES
  ...
  passes a day, far past the Alchemy free tier, so production runs --every=3600 --budget=125
  (24 samples a day, ~3.5k RPC calls a day — the same load as the earlier 3-hourly --budget=400).
