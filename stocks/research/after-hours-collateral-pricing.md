...
**Loans.**
- 12 loans hold xStock collateral ($3,962 principal). 9 of them are in the USDC Orca market ($3,911 principal); the other 3 are in market `Go6kfC…`, which uses a different oracle (type 19), and their terms end 2026-09-25 and 2026-11-08, so they are not overdue (corrected 2026-09-24 15:30 UTC).
