...
export const COLLECTOR_SPECS = [
    ...
    { id: 'lending-watch', label: 'Lending liquidations & price freezes', cadenceHours: 1, file: 'lendingWatch', timestamp: 'lastRunEndedAt', fallbackTimestamp: 'generatedAt', countPath: ['accountsWatched'], unit: 'lending accounts watched', source: 'Solana RPC; Kamino, Jupiter Lend, Nest and Loopscale transactions' },
...
export async function refreshCollectorStatus({ outputs = [join(ROOT, 'stocks-collector-status.json')] } = {}) {
    const files = {
        ...
        lendingWatch: '.last-lending-watch-stats.json',
