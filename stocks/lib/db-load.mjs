...
const SNAPSHOT_COLUMNS = [
    ...
    ['market_value_usd', "(r->>'marketValueUsd')::double precision"],
    ...
    ['market_health', "r->>'marketHealth'"],
    ['control_health', "r->>'controlHealth'"],
    ['legal_health', "r->>'legalHealth'"],
    ['composability_health', "r->>'composabilityHealth'"],
    ['defi_protocol_count', "(r->>'defiProtocolCount')::int"],
    ['defi_integration_count', "(r->>'defiIntegrationCount')::int"],
    ['first_seen_at', "(r->>'firstSeenAt')::timestamptz"],
    ['seen_in_search', "(r->>'seenInSearch')::bool"],
    ['row', 'r'],
    ['built_at', 'built_at']
